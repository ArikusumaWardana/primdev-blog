      ...
      <div class="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-sm mx-4">
        ...
        <form @submit.prevent="register" method="post" class="text-sm">
          ...
          <div class="flex items-center justify-between mb-6">
            <button type="submit" class="w-full py-2 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold focus:outline-none focus:ring focus:ring-blue-500 uppercase flex justify-center items-center">
